...
import com.example.library.category.CategoryDTO;
...
public class BookRestController {
	...
	private Book mapBookDTOToBook(BookDTO bookDTO) {
		ModelMapper mapper = new ModelMapper();
		// In this example, the ModelMapper instance handles the mapping between Person
		// and PersonDTO objects.
		// It automatically matches fields with similar names and types
